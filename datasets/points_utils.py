...
def transform_pc_between_boxes(pc, from_box, to_box):
    pc_world = copy.deepcopy(pc)
    pc_world.rotate(from_box.rotation_matrix)  #
    pc_world.translate(from_box.center)        # 
    
    pc_world.translate(-to_box.center)         # 
    pc_world.rotate(to_box.rotation_matrix.T)  # 
